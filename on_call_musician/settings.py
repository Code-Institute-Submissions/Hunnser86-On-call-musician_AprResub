"""
Django settings for on_call_musician project.
...
SECRET_KEY = 'django-insecure-3&hcebjwgvgl+!^i#s*$^*@ffboj-thu(2z@07(v5dklz&hf6l'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['on-call-musician.herokuapp.com', 'localhost']
...
ROOT_URLCONF = 'on_call_musician.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.request',  # request by allauth
...
roject to save development time.
"""
...
WSGI_APPLICATION = 'on_call_musician.wsgi.application'
